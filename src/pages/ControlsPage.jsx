...
const ControlsPage = () => {
    ...
    return (
        <div className="w-screen h-screen bg-gray-900/95 text-cyan-100 font-mono p-4 border border-cyan-500/50 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-4 border-b border-cyan-500/30 bg-cyan-900/20 shrink-0">
            ...
            <div className="p-4 bg-black/50 text-[10px] text-gray-500 text-center border-t border-gray-800 shrink-0">
