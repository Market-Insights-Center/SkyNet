...
const SidebarPage = () => {
    ...
    return (
        <div className="w-screen h-screen bg-deep-black text-cyan-100 font-mono overflow-hidden relative">
            <LiquidBackground />

            <div className="absolute inset-0 z-10 flex flex-col backdrop-blur-3xl bg-black/60 border-l border-white/10">
                {/* HEADER */}
                <div className="p-2 border-b border-white/10 bg-white/5 flex items-center justify-between shrink-0 select-none backdrop-blur-md">
                ...
                {/* FOOTER */}
                <div className="p-2 border-t border-white/10 bg-black/40 shrink-0 space-y-2 backdrop-blur-md">
                    <button onClick={handleTerminate} className="w-full flex items-center justify-center gap-2 bg-red-900/20 hover:bg-red-900/50 text-red-200 py-1.5 rounded border border-red-500/30 transition-all text-xs font-bold uppercase tracking-wider backdrop-blur-sm shadow-[0_0_10px_rgba(255,0,0,0.2)]">
