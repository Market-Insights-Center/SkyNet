...
const PerformanceStream = () => {
    ...
    if (!userProfile || (userProfile.tier !== 'Enterprise' && userProfile.tier !== 'Singularity')) {
        return (
            <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
                <div className="text-center max-w-lg">
                    <h1 className="text-3xl font-bold text-gray-500 mb-4">Access Restricted</h1>
                    <p className="text-gray-400 mb-6">The Market Heatmap is an exclusive tool for Enterprise and Singularity members.</p>
                    <button onClick={() => navigate('/products')} className="px-6 py-2 bg-purple-600 rounded hover:bg-purple-500">Go Back</button>
                </div>
            </div>
        );
    }
