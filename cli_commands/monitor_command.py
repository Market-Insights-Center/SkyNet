...
try:
    ...
    from backend.integration.tracking_command import _load_portfolio_run
    ...
    try:
        ...
        from integration.tracking_command import _load_portfolio_run
        from integration.risk_command import perform_risk_calculations_singularity
    except ImportError:
         print("Warning: monitor_command failed to import backend modules.")
         calculate_ema_invest = None
         _load_portfolio_run = None
         perform_risk_calculations_singularity = None
